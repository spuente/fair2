...
class ContestantsControllerTest < ActionController::TestCase
  ...
  test "should create contestant" do
    assert_difference('Contestant.count') do
      post :create, contestant: { email: @contestant.email, lastname: @contestant.lastname, name: @contestant.name, phone: @contestant.phone }
    end
  ...
  test "should update contestant" do
    patch :update, id: @contestant, contestant: { email: @contestant.email, lastname: @contestant.lastname, name: @contestant.name, phone: @contestant.phone }
    assert_redirected_to contestant_path(assigns(:contestant))
  end
